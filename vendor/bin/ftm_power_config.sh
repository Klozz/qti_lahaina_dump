...
echo 0 > /sys/kernel/tracing/tracing_on && cat /sys/kernel/tracing/trace > /mnt/vendor/opporeserve/ftm_admin/trace.txt && echo 0 > /sys/kernel/tracing/tracing_on && echo "" > /sys/kernel/tracing/trace && sleep 1 && echo 1 > /sys/kernel/tracing/tracing_on && sleep 40 && echo 0 > /sys/kernel/tracing/tracing_on && cat /sys/kernel/tracing/trace > /mnt/vendor/opporeserve/ftm_admin/trace.txt&
